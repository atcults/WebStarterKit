...
namespace Common.Base
{
    ...
    internal static class ExpressionUtil
    {
        ...
        {
            var inp = Expression.Parameter(typeof(TArg), "inp");
            ...
            try
            {
                ...
                catch (InvalidOperationException)
                {
                            ...
                            typeof(TArg2) == typeof(TResult)))
                    {
                        ...
                        var castLhs = typeof(TArg1) == typeof(TResult) ? lhs : (Expression)Expression.Convert(lhs, typeof(TResult));
                        var castRhs = typeof(TArg2) == typeof(TResult) ? rhs : (Expression)Expression.Convert(rhs, typeof(TResult));
