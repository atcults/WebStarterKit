...
namespace Common.Net.Proxy
{
    ...
    public class Socks4ProxyClient : IProxyClient
    {
        ...
        /// </summary>
        internal const int SocksProxyDefaultPort = 1080;
        /// <summary>
        /// Socks4 version number.
        /// </summary>
        internal const byte Socks4VersionNumber = 4;
        /// <summary>
        /// Socks4 connection command value.
        /// </summary>
        internal const byte Socks4CmdConnect = 0x01;
        /// <summary>
        /// Socks4 bind command value.
        /// </summary>
        internal const byte Socks4CmdBind = 0x02;
        /// <summary>
        /// Socks4 reply request grant response value.
        /// </summary>
        internal const byte Socks4CmdReplyRequestGranted = 90;
        /// <summary>
        /// Socks4 reply request rejected or failed response value.
        /// </summary>
        internal const byte Socks4CmdReplyRequestRejectedOrFailed = 91;
        /// <summary>
        /// Socks4 reply request rejected becauase the proxy server can not connect to the IDENTD server value.
        /// </summary>
        internal const byte Socks4CmdReplyRequestRejectedCannotConnectToIdentd = 92;
        /// <summary>
        /// Socks4 reply request rejected because of a different IDENTD server.
        /// </summary>
        internal const byte Socks4CmdReplyRequestRejectedDifferentIdentd = 93;
        ...
        public Socks4ProxyClient(string proxyHost, string proxyUserId)
        {
            ...
            _proxyPort = SocksProxyDefaultPort;
        ...
        public TcpClient CreateConnection(string destinationHost, int destinationPort)
        {
            ...
            try
            {
                ...
                SendCommand(_tcpClient.GetStream(), Socks4CmdConnect, destinationHost, destinationPort, _proxyUserId);
        ...
        internal virtual void SendCommand(NetworkStream proxy, byte command, string destinationHost, int destinationPort, string userId)
        {
            ...
            if (response[1] != Socks4CmdReplyRequestGranted)
        ...
        internal void HandleProxyCommandError(byte[] response, string destinationHost, int destinationPort)
        {
            ...
            var exceptionMsg = String.Format(CultureInfo.InvariantCulture, "The {0} concerning destination host {1} port number {2}.  The destination reported the host as {3} port {4}.", proxyErrorText, destinationHost, destinationPort, ipAddr, port.ToString(CultureInfo.InvariantCulture));
