...
namespace Common.Net.Proxy
{
    ...
    public class Socks4AProxyClient : Socks4ProxyClient
    {
        ...
        public Socks4AProxyClient(string proxyHost, int proxyPort, string proxyUserId) : base(proxyHost, proxyPort, proxyUserId)
        {
        ...
        /// <param name="proxyHost">Host name or IP address of the proxy server.</param>
        /// <param name="proxyPort">Port used to connect to proxy server.</param>
        public Socks4AProxyClient(string proxyHost, int proxyPort) : base(proxyHost, proxyPort)
        {
