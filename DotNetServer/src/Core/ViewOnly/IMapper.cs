...
namespace Core.ViewOnly
{
    ...
    {
        /// <summary>
        ///     Get information about the view associated with a POCO class
        /// </summary>
        /// <param name="pocoType"></param>
        /// <returns>A ViewInfo instance</returns>
        /// <remarks>
        ///     This method must return a valid ViewInfo.
        /// </remarks>
        ViewInfo GetViewInfo(Type pocoType);
