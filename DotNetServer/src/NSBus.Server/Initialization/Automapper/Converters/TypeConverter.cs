/*
 * 
 * http://stackoverflow.com/questions/4101516/automapper-how-to-parse-an-int-from-a-string-and-possible-to-creating-rules-bas
namespace WebApp.Initialization.Automapper.Converters
{
